<footer class="bg-dark border-top col-12 d-flex flex-column justify-content-around align-items-center mt-5" style="min-height: 300px; box-shadow: 0px -2px 10px black">
    <div class="col-10 d-flex flex-column align-items-center pt-5">
        <label for="" class="h3 fw-bold text-light">ACADEMY EXELENT</label>
