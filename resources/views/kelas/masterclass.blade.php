<x-layout>
    <div style="background: #F4EBD0; min-height: 91.8vh;">
        <div class="w-100 d-flex justify-content-center">
            <label for="" class="h2 fw-bold mt-5">MASTER CLASS</label>
        </div>
        <div class="d-flex flex-wrap flex-column flex-xl-row gap-3 gap-xl-5 col-12 mt-5 align-items-center justify-content-center">
            <a href="{{ route('siswa.kelas') }}" class="col-11 text-decoration-none justify-content-start ps-4 ps-xl-0 h1 align-items-center col-xl-2 shadow text-xl-center text-right py-xl-5 rounded bg-warning d-flex flex-xl-column justify-xl-content-center align-items-center" style="height: fit-content">
            ...
            <a href="" class="col-11 text-decoration-none justify-content-start ps-4 ps-xl-0 h1 align-items-center col-xl-2 shadow text-xl-center text-right py-xl-5 rounded bg-warning d-flex flex-xl-column justify-xl-content-center align-items-center" style="height: fit-content">
